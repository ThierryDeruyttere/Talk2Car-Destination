...
def main(args):
    ...
    for bidx, data in enumerate(tqdm(test_loader)):
        ...
        object_boxes, referred_object = data["object_boxes"], data["referred_object"]
        ...
        pred_object_indices = random.choices(
            list(range(referred_object.shape[1])), k=1000
        )
        pred_coord = referred_object[:, pred_object_indices]
        """PRED COORD"""
