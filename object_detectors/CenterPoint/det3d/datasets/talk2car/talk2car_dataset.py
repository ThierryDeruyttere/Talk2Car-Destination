...
class Talk2CarDataset(PointCloudDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(Talk2CarDataset, self).__init__(
        ...
        self._num_point_features = Talk2CarDataset.NumPointFeatures
    ...
    def evaluation(self, detections, output_dir=None, testset=False):
        ...
        nusc = Talk2Car(version=version, dataroot=str(self._root_path), verbose=True)
