...
4. Download the Talk2Car-Destination dataset [here](https://drive.google.com/file/d/1xNECDDTEDA2rV0lkHhPDsUHG7OvO4aFs/view?usp=sharing) and put all files in the data folder. We also include pre-extracted commmand embeddings with a Sentence-BERT model in the .h5 files in this zip.
