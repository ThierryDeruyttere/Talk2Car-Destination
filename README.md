...
4. Download the Talk2Car-Destination dataset [here](https://drive.google.com/file/d/1DS8_90IPm81oeFHnjUGleeFitCnWXH7E/view?usp=share_link) and put all files in the data folder. We also include pre-extracted commmand embeddings with a Sentence-BERT model in the .h5 files in this zip.
